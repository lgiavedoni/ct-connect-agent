    ...
    <Constraints.Horizontal max={16}>
      <Spacings.Stack scale="xl">
        ...
        <Spacings.Stack scale="l">
          ...
          <Text.Subheadline as="h4" intlMessage={messages.aiAssistantTitle} />
          <Grid
            gridGap="16px"
            gridAutoColumns="1fr"
          ...
          >
            <InfoCard
              title={intl.formatMessage(messages.cardChatTitle)}
              content={intl.formatMessage(messages.cardChatContent)}
              linkTo={`${match.url}/chat`}
            />
          </Grid>
        </Spacings.Stack>
      </Spacings.Stack>
