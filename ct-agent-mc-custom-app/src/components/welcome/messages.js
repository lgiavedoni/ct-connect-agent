...
export default defineMessages({
  ...
  aiAssistantTitle: {
    id: 'Welcome.aiAssistantTitle',
    defaultMessage: 'AI Assistant',
  },
  cardChatTitle: {
    id: 'Welcome.cardChatTitle',
    defaultMessage: 'AI Chat Assistant',
  },
  cardChatContent: {
    id: 'Welcome.cardChatContent',
    defaultMessage:
      'Chat with our AI assistant to get help with your questions about commercetools.',
  },
});
