...
import { aiRunPrompt, model_flash_thinking, model_openai_gpt_4_o, model_openai_o3_mini } from '../client/ai.client';
...
const systemPrompt: string = `
    ...
    ***NEVER try to create a GraphQL query yourself - always use the generateGraphQLQuery tool.***
    ...
    <return_format>
        ...
        {
          "answer": "The answer to the user's request. Give him the answer, not how you got it. And specially not how you will get there. Do it",
...
export const angetHandler = async (request: AgentRequest, response: Response): Promise<Response> => {
  try {
    ...
    const aiResponse = await aiRunPrompt(
      human_request, 
      systemPrompt, 
      [generateGraphQLQuery, executeGraphQLQuery],model_openai_gpt_4_o//model_openai_o3_mini
    );
