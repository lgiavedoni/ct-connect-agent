...
import { aiRunPrompt, aiRunPromptWithUserPrompt, model_flash_thinking, model_openai_gpt_4_o, model_openai_o3_mini, aiRunPromptStream, model_openai_gpt_4_5, model_openai_gpt_4_1 } from '../client/ai.client';
...
const systemPrompt: string = `
    ...
    *** NEVER alucinate with data, or make up data.***
    ...
    <return_format>
      The answer to the user's request. Give him the answer, not how you got it.
      The user is a human, so your response should be in a natural language and easy to understand. NEVER JSON
